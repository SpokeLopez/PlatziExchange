            ...
            <tr class="bg-gray-100 border-b-2 border-gray-400">
                ...
                <td class="hidden sm:block">
                    <input
                        ...
                        id="filter" placeholder="Buscar..." type="text" v-model="filter" />
                </td>
            </tr>
        </thead>
        <tbody>
            <tr v-for="a in filteredAssets"
            :key="a.id" 
            class="border-b border-gray-200 ho ver:bg-gray-100 hover:bg-orange-100">
                <td>
                    <img 
                    class="w-8 h-8"
